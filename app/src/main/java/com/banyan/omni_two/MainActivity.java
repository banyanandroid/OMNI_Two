...
public class MainActivity extends FragmentActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_preg) {
            ...
            Intent in = new Intent(MainActivity.this, Pregnancy_Activity.class);
            startActivity(in);
            ...
            Intent in = new Intent(MainActivity.this, Cancer_Activity.class);
            startActivity(in);

        } else if (id == R.id.nav_rp) {
            // Handle the Phych action
            Intent in = new Intent(MainActivity.this, Radio_Activity.class);
            startActivity(in);

        } else if (id == R.id.nav_ai) {
            // Handle the Neuro action
            Intent in = new Intent(MainActivity.this, Anti_Inflamation_Activity.class);
            startActivity(in);
