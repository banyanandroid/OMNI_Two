...
public class Fragment_15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layoutView = inflater.inflate(R.layout.fragment_lay_15, container,
                false);
        ...
        gold_img.setImageResource(R.drawable.frag15_goldimg);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.frag15, fragment_14);
        ...
        /*next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.frag11, fragment_13);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            }
        });*/
