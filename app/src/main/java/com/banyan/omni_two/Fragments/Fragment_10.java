...
public class Fragment_10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layoutView = inflater.inflate(R.layout.fragment_lay_10, container,
                false);
        ...
        gold_img.setImageResource(R.drawable.frag10_goldimg);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.frag10, fragment_9);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.frag10, fragment_11);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            }
        });
